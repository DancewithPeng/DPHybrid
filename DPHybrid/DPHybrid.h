...
//! Project version number for DPHybrid.
FOUNDATION_EXPORT double DPHybridVersionNumber;

//! Project version string for DPHybrid.
FOUNDATION_EXPORT const unsigned char DPHybridVersionString[];
